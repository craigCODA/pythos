#!/usr/bin/env python
"""Build and verify the isolated native ICMP probe ELF."""
...
PROBE_LINKER = ROOT / "user" / "probes" / "icmp" / "linker.ld"
DEFAULT_TARGET_DIR = ROOT / "target" / "icmp-probe"
...
def main() -> int:
    ...
    artifact = args.target_dir / "icmp-probe.elf"
