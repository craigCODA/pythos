#!/usr/bin/env python
"""Build and verify the bounded native capability-gated socket probe ELF."""
...
def main() -> int:
    ...
    if result != 0:
        return result
    cargo_elf = args.target_dir / "x86_64-unknown-none" / "debug" / "socket-probe"
    ...
    artifact = args.target_dir / "socket-probe.elf"
