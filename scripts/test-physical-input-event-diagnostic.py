#!/usr/bin/env python
"""QEMU acceptance for the opt-in physical input event diagnostic."""
...
TARGET = ROOT / "target"
SERIAL_LOG = TARGET / "physical-input-event-diagnostic-com1.log"
READY_MARKER = "PYTHOS:CORE:PHYSICAL_INPUT:READY"
ACCEPTED_MARKER = "PYTHOS:CORE:PHYSICAL_INPUT:ACCEPTED"
...
def build_boot_image() -> None:
    ...
    run(
        [
            ...
            "x86_64-unknown-none",
            "--features",
            "verify,physical-input-event-diagnostic",
        ]
    )
...
def main() -> int:
    ...
    try:
        ...
        launcher_click.type_physical_input_event_sequence()
    ...
    print("PHYSICAL_INPUT_EVENT_DIAGNOSTIC_TEST_OK")
    return 0
