#!/usr/bin/env python
"""Build and verify the bounded native DNS probe ELF."""
...
PROBE_LINKER = ROOT / "user" / "probes" / "dns" / "linker.ld"
...
def main() -> int:
    ...
    artifact = args.target_dir / "dns-probe.elf"
