#!/usr/bin/env python
"""Build and verify the isolated native IPv4 probe ELF."""
...
PROBE_LINKER = ROOT / "user" / "probes" / "ipv4" / "linker.ld"
DEFAULT_TARGET_DIR = ROOT / "target" / "ipv4-probe"
...
def main() -> int:
    ...
    artifact = args.target_dir / "ipv4-probe.elf"
