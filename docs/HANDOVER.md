...
Branch `docs/pythtig-phase0-from-physical-evidence` imports the proposed Pyth
Native Typed Instruction Graph program as docs-only Phase 0 adoption material
on top of `agent/physical-evidence-terminal`. PythTIG is proposed architecture
pending owner adoption, not the active implementation program.
...
The proposed PythTIG ADRs are renumbered against this branch:
...
This branch keeps the ADR 0063 evidence-terminal implementation baseline
intact and records the full reconciliation in
