...
Next, continue Phase 2 with `task-termination`. Do not pull in scheduler-tests,
IPC, Python, or any later phase while building the task-termination slice.
