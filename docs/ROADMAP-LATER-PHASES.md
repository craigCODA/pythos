...
Phase 15 opening slices accepted locally  PCI identity + BAR layout probes
                                       ADRs 0105-0106; hardware expansion continues
```
...
accepted Phase 15 opening slices are the read-only PCI network-identity and
BAR-layout probes under ADRs 0105-0106. The Lenovo BAR values are
target-specific configuration metadata; they do not establish BAR reachability,
physical networking, Lenovo Wi-Fi, controller operation, or later hardware
support. Later Phase 15 expansion and Phases 16-17 remain separately invoked
work.

ADRs are allocated through 0106 in this checkout. Check `docs/decisions/` and
