...
fn syscall5(number: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) -> u64 {
    ...
    // 4. Pointer ownership: callers retain their buffers; PythCore accesses them only during dispatch.
    ...
    // 7. Concurrency: the session runtime is single-threaded and issues one syscall at a time.
    // 8. Violation: invalid registers or memory are rejected by PythCore or fault this process.
    unsafe {
        asm!(
            "syscall",
