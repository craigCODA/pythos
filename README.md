...
[![QEMU Acceptance](https://github.com/craigCODA/pythos/actions/workflows/qemu-acceptance.yml/badge.svg?branch=feature/sdhci-emmc-backend)](https://github.com/craigCODA/pythos/actions/workflows/qemu-acceptance.yml?query=branch%3Afeature%2Fsdhci-emmc-backend)
...
SDHCI/eMMC block backends verified in QEMU. The SDHCI/eMMC backend has reached
its Phase 10 physical acceptance panel once on the disposable O2 Micro
`1217:8620` laptop; the two-cold-boot physical acceptance gate is still being
completed.
